  ...
  implements Serializable
{
  ...
  @Excel(name="客户简称", width=15.0D)
  private String cusCode;
  @Excel(name="客户类型", width=15.0D)
  private String cusType;
  @Excel(name="客户来源", width=15.0D)
  private String cusFrom;
  @Excel(name="客户地址", width=15.0D)
  private String address;
  @Excel(name="联系人电话", width=15.0D)
  private String telphone;
  @Excel(name="办公传真", width=15.0D)
  private String fax;
  @Excel(name="公司网址", width=15.0D)
  ...
  @Excel(name="实际业务量", width=15.0D)
  private String ywl;
  @Excel(name="单位", width=15.0D)
  private String unit;
  @Excel(name="实际业务金额", width=15.0D)
  private String ywMoney;
  @Excel(name="币种", width=15.0D)
  private String bz;
  @Excel(name="潜在业务量/年", width=15.0D)
  private String qzywl;
  @Excel(name="单位", width=15.0D)
  private String qzunit;
  @Excel(name="潜在业务金额/年", width=15.0D)
  private String qzywMoney;
  @Excel(name="币种", width=15.0D)
  private String qzbz;
  @Excel(name="建立商业关系时间", width=15.0D)
  private String relationDate;
  @Excel(name="国家", width=15.0D)
  private String guoJia;
  @Excel(name="主联系人", width=15.0D)
  private String zlxr;
  @Excel(name="业务联系人一", width=15.0D)
  private String ywlxr1;
  @Excel(name="业务联系人二", width=15.0D)
  private String ywlxr2;
  @Excel(name="业务联系人三", width=15.0D)
  private String ywlxr3;
  @Excel(name="试身联系人", width=15.0D)
  private String sslxr;
  @Excel(name="包装联系人", width=15.0D)
  private String bzlxr;
  @Excel(name="测试联系人", width=15.0D)
  private String cslxr;
  @Excel(name="质量联系人", width=15.0D)
  private String zllxr;
  @Excel(name="验厂联系人", width=15.0D)
  private String yclxr;
  @Excel(name="船务联系人", width=15.0D)
  private String cwlxr;
  @Excel(name="法律联系人", width=15.0D)
