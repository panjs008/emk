  ...
  implements Serializable
{
  ...
  @Excel(name="联系人ID", width=15.0D)
  private String contactId;
  @Excel(name="跟进人", width=15.0D)
  private String traceName;
  @Excel(name="跟进人ID", width=15.0D)
  private String traceId;
  @Excel(name="跟进方式", width=15.0D)
  private String traceType;
  @Excel(name="跟进状态", width=15.0D)
  private String traceState;
  @Excel(name="跟进内容", width=15.0D)
  private String traceContent;
  @Excel(name="跟进时间", width=15.0D)
