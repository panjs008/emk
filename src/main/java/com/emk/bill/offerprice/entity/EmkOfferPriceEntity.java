...
public class EmkOfferPriceEntity
  implements Serializable
{
  ...
  @Excel(name="款式", width=15.0D)
  private String proTypeName;
  @Excel(name="款式", width=15.0D)
  private String proType;
  @Excel(name="加工费", width=15.0D)
  private Double workPrice;
  @Excel(name="厂皮损耗费", width=15.0D)
  private Double lossPrice;
  @Excel(name="商检运费", width=15.0D)
  private Double freightPrice;
  @Excel(name="税费", width=15.0D)
  private Double tax;
