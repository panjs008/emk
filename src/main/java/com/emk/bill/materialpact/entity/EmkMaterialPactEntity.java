...
public class EmkMaterialPactEntity
  implements Serializable
{
  ...
  @Excel(name="总用量", width=15.0D)
  private String sumUse;
  @Excel(name="甲方", width=15.0D)
  private String partyA;
  @Excel(name="甲方ID", width=15.0D)
  private String partyAId;
  @Excel(name="乙方", width=15.0D)
  private String partyB;
  @Excel(name="乙方ID", width=15.0D)
  private String partyBId;
  @Excel(name="FOB", width=15.0D)
  private String fob;
  @Excel(name="交货地点", width=15.0D)
  private String place;
  @Excel(name="类型", width=15.0D)
  private String type;
  @Excel(name="原产地", width=15.0D)
  private String ycd;
  @Excel(name="付款方式", width=15.0D)
  private String payType;
  @Excel(name="授权代表", width=15.0D)
  private String sqdb;
  @Excel(name="地址", width=15.0D)
  private String address;
  @Excel(name="电话", width=15.0D)
  private String telphone;
  @Excel(name="签定日期", width=15.0D)
