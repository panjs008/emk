...
@Transactional
public class EmkStorageLogServiceImpl
  extends CommonServiceImpl
  implements EmkStorageLogServiceI
{
  public void delete(EmkStorageLogEntity entity)
    throws Exception
  {
    super.delete(entity);
  ...
  public Serializable save(EmkStorageLogEntity entity)
    throws Exception
  {
  ...
  public void saveOrUpdate(EmkStorageLogEntity entity)
    throws Exception
  {
  ...
  private void doAddBus(EmkStorageLogEntity t)
    throws Exception
  {}
  
  private void doUpdateBus(EmkStorageLogEntity t)
    throws Exception
  {}
  
  private void doDelBus(EmkStorageLogEntity t)
    throws Exception
  {}
