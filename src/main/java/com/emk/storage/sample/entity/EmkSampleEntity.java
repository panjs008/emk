  ...
  implements Serializable
{
  ...
  @Excel(name="计划号", width=15.0D)
  private String projectNo;
  @Excel(name="供应商", width=15.0D)
  private String factoryName;
  @Excel(name="供应商代码", width=15.0D)
  private String factoryCode;
  @Excel(name="客户原样URL", width=15.0D)
  private String customSampleUrl;
  @Excel(name="客户原样", width=15.0D)
  private String customSample;
  @Excel(name="尺寸表URL", width=15.0D)
  private String sampleSizeUrl;
  @Excel(name="尺寸表", width=15.0D)
  private String sampleSize;
  @Excel(name="备注", width=15.0D)
  private String remark;
  @Excel(name="包装方案", width=15.0D)
  private String packing;
  @Excel(name="商品名称", width=15.0D)
  private String proName;
  @Excel(name="产品类别", width=15.0D)
  private String proType;
  @Excel(name="产品类别名称", width=15.0D)
  private String proTypeName;
  @Excel(name="交货时间", width=15.0D)
  private String receviceDate;
  @Excel(name="样衣完成时间", width=15.0D)
  private String finishDate;
  @Excel(name="生产板完成时间", width=15.0D)
  private String produceDate;
  @Excel(name="要求", width=15.0D)
  ...
  @Excel(name="染色意见", width=15.0D)
  private String rsAdvice;
  @Excel(name="质检员意见", width=15.0D)
