...
public class EmkMaterialEntity
  implements Serializable
{
  ...
  @Excel(name="采购员", width=15.0D)
  private String cger;
  @Excel(name="采购员ID", width=15.0D)
  private String cgerName;
  @Excel(name="样品交期", width=15.0D)
  private String ypjqDate;
  @Excel(name="距样品交期剩余天数", width=15.0D)
  private Integer leaveYpjqDays;
  @Excel(name="距大货交期剩余天数", width=15.0D)
  private Integer leaveDhjqDays;
  @Excel(name="是否有订单", width=15.0D)
  private String isOrder;
  @Excel(name="大货交期", width=15.0D)
  private String dhjqDate;
  @Excel(name="是否现有原料面料", width=15.0D)
  private String isHave;
  @Excel(name="版次", width=15.0D)
  private String version;
  @Excel(name="打样原因", width=15.0D)
  private String sampleReason;
  @Excel(name="需求开发交期", width=15.0D)
  private String requiredJqDate;
  @Excel(name="完成时间剩余天数", width=15.0D)
  private Integer leaveFinishDays;
  @Excel(name="开发单状态", width=15.0D)
  private String state;
  @Excel(name="技术员意见", width=15.0D)
