  ...
  implements Serializable
{
  ...
  @Excel(name="开发完成交期", width=15.0D)
  private String endDate;
  @Excel(name="客户意见", width=15.0D)
  private String cusAdvice;
  @Excel(name="业务意见", width=15.0D)
  private String yeAdvice;
  @Excel(name="采购部意见", width=15.0D)
  private String cgAdvice;
  @Excel(name="是否参考图片", width=15.0D)
  private String isCkImage;
  @Excel(name="参考图片", width=15.0D)
