    ...
    public String doPrintPDF(String ids,EmkEnquiryEntity emkEnquiry, HttpServletRequest request,HttpServletResponse response) {
        ...
        try {
            for (String id : ids.split(",")) {
                ...
                new createPdf(file).generateEmkEnquiryPDF(emkEnquiryEntityA,emkProOrderDetailEntities,emkSizeEntity);
                    ...
                    if (task.size() > 0) {
                        ...
                        if(task1.getTaskDefinitionKey().equals("ywbCheckTask")) {
                            if (map.get("isPass").equals("0")) {
                                ...
                                saveApprvoalDetail(approvalDetail,"业务经理审核","enquiryTask",1,"回退");
                        ...
                        if(task1.getTaskDefinitionKey().equals("jsbCheckTask")) {
                            if (map.get("isPass").equals("0")) {
                                ...
                                saveApprvoalDetail(approvalDetail,"技术部批复","jsbCheckTask",1,"回退");
                        ...
                        if(task1.getTaskDefinitionKey().equals("ranCheckTask")) {
                            if (map.get("isPass").equals("0")) {
                                ...
                                saveApprvoalDetail(approvalDetail,"染色部批复","ranCheckTask",1,"回退");
                        ...
                        if(task1.getTaskDefinitionKey().equals("fengCheckTask")) {
                            if (map.get("isPass").equals("0")) {
                                ...
                                saveApprvoalDetail(approvalDetail,"缝制部批复","fengCheckTask",1,"回退");
                        ...
                        if(task1.getTaskDefinitionKey().equals("biaoTask")) {
                            if (map.get("isPass").equals("0")) {
                                ...
                                saveApprvoalDetail(approvalDetail,"烫标整烫组批复","biaoTask",1,"回退");
                        ...
                        if(task1.getTaskDefinitionKey().equals("baoTask")) {
                            if (map.get("isPass").equals("0")) {
                                ...
                                saveApprvoalDetail(approvalDetail,"包装组批复","baoTask",1,"回退");
                        ...
                        if(task1.getTaskDefinitionKey().equals("caiTask")) {
                            if (map.get("isPass").equals("0")) {
                                ...
                                saveApprvoalDetail(approvalDetail,"采购部批复","baoTask",1,"回退");
                        ...
                        if(task1.getTaskDefinitionKey().equals("scbCheckTask")) {
                            if (map.get("isPass").equals("0")) {
                                ...
                                saveApprvoalDetail(approvalDetail,"生产计划部批复","scbCheckTask",1,"回退");
                        ...
                        if(task1.getTaskDefinitionKey().equals("sczfzrpfTask")) {
                            if (map.get("isPass").equals("0")) {
                                ...
                                saveApprvoalDetail(approvalDetail,"生产总负责人批复","sczfzrpfTask",1,"回退");
                        ...
                        if(task1.getTaskDefinitionKey().equals("replyCustomTask")) {
                            ...
                            if (map.get("cusType").equals("0")) {
                                ...
                                String priceNo = savePrice(t,map.get("userName"),map.get("realName"));
