  ...
  implements Serializable
{
  ...
  @Excel(name="海关编码", width=15.0D)
  private String hsCode;
  @Excel(name="海关名称", width=15.0D)
  private String hsName;
  @Excel(name="报关要素", width=15.0D)
  private String bgys;
  @Excel(name="增值税率", width=15.0D)
  private String zzVal;
  @Excel(name="退税率", width=15.0D)
  private String tsVal;
  @Excel(name="销售指导价", width=15.0D)
