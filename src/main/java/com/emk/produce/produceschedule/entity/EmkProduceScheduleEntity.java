...
public class EmkProduceScheduleEntity
  implements Serializable
{
  ...
  @Excel(name="原料布料状态", width=15.0D)
  private String ylblState;
  @Excel(name="原料布料到厂日期", width=15.0D)
  private String ylblLimitDate;
  @Excel(name="距原料到厂剩余天数", width=15.0D)
  private Integer leavelYlblDay;
  @Excel(name="缝制辅料状态", width=15.0D)
  private String fzblState;
  @Excel(name="缝制辅料到厂日期", width=15.0D)
  private String fzblLimitDate;
  @Excel(name="距缝制到厂剩余天数", width=15.0D)
  private Integer leavelFzblDay;
  @Excel(name="包装辅料状态", width=15.0D)
  private String bzblState;
  @Excel(name="包装辅料到厂日期", width=15.0D)
  private String bzblLimitDate;
  @Excel(name="距包装到厂剩余天数", width=15.0D)
  private Integer leavelBzblDay;
  @Excel(name="染色状态", width=15.0D)
  private String ranState;
  @Excel(name="染色已完成数量", width=15.0D)
  private String ranFinish;
  @Excel(name="染色未完成数量", width=15.0D)
  private String ranUnfinish;
  @Excel(name="裁剪状态", width=15.0D)
  private String caiState;
  @Excel(name="裁剪已完成数量", width=15.0D)
  private String caiFinish;
  @Excel(name="裁剪未完成数量", width=15.0D)
  private String caiUnfinish;
  @Excel(name="缝制状态", width=15.0D)
  private String fzState;
  @Excel(name="缝制已完成数量", width=15.0D)
  private String fzFinish;
  @Excel(name="缝制未完成数量", width=15.0D)
  private String fzUnfinish;
  @Excel(name="烫标状态", width=15.0D)
  private String btState;
  @Excel(name="烫标已完成数量", width=15.0D)
  private String btFinish;
  @Excel(name="烫标未完成数量", width=15.0D)
  private String btUnfinish;
  @Excel(name="整烫状态", width=15.0D)
  private String ztState;
  @Excel(name="整烫已完成数量", width=15.0D)
  private String ztFinish;
  @Excel(name="整烫未完成数量", width=15.0D)
  private String ztUnfinish;
  @Excel(name="包装状态", width=15.0D)
  private String bzState;
  @Excel(name="包装已完成数量", width=15.0D)
  private String bzFinish;
  @Excel(name="包装已完成数量", width=15.0D)
  private String bzUnfinish;
  @Excel(name="出货日期", width=15.0D)
