  ...
  implements Serializable
{
  ...
  private String bz;
  @Excel(name="总箱数", width=15.0D)
  private Integer sumBoxTotal;
  @Excel(name="总体积", width=15.0D)
  private Double sumBoxVolume;
  @Excel(name="总净重", width=15.0D)
  private Double sumBoxJz;
  @Excel(name="总毛重", width=15.0D)
  ...
  @Excel(name="订舱通知单号", width=15.0D)
  private String cargoNo;
  @Excel(name="提交日期", width=15.0D)
  private String kdDate;
  @Excel(name="出货通知单号", width=15.0D)
  private String outForumNo;
  @Excel(name="离厂放行条号", width=15.0D)
  private String levealFactoryNo;
  @Excel(name="供应商", width=15.0D)
  private String gys;
  @Excel(name="供应商", width=15.0D)
  private String gysCode;
  @Excel(name="船务员", width=15.0D)
  private String cwyer;
  @Excel(name="货代名称", width=15.0D)
  private String hdName;
  @Excel(name="目的国", width=15.0D)
  private String destination;
  @Excel(name="货好时间", width=15.0D)
  private String haoDate;
  @Excel(name="开船时间", width=15.0D)
  private String goDate;
  @Excel(name="发票号", width=15.0D)
  private String fpNum;
  @Excel(name="到港时间", width=15.0D)
  private String arrvieDate;
  @Excel(name="收货人", width=15.0D)
  ...
  @Excel(name="长度", width=15.0D)
  private String chang;
  @Excel(name="宽度", width=15.0D)
  private String kuan;
  @Excel(name="高度", width=15.0D)
  private String gao;
  @Excel(name="单箱毛重", width=15.0D)
  private String oneMz;
  @Excel(name="单箱净重", width=15.0D)
  private String oneJz;
  @Excel(name="单箱体积", width=15.0D)
  private String oneVolume;
  @Excel(name="金额", width=15.0D)
  private String money;
  @Excel(name="订舱状态", width=15.0D)
  private String cargoState;
  @Excel(name="出厂状态", width=15.0D)
