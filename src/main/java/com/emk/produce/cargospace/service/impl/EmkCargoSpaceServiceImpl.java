...
@Transactional
public class EmkCargoSpaceServiceImpl
  extends CommonServiceImpl
  implements EmkCargoSpaceServiceI
{
  public void delete(EmkCargoSpaceEntity entity)
    throws Exception
  {
    super.delete(entity);
  ...
  public Serializable save(EmkCargoSpaceEntity entity)
    throws Exception
  {
  ...
  public void saveOrUpdate(EmkCargoSpaceEntity entity)
    throws Exception
  {
  ...
  private void doAddBus(EmkCargoSpaceEntity t)
    throws Exception
  {}
  
  private void doUpdateBus(EmkCargoSpaceEntity t)
    throws Exception
  {}
  
  private void doDelBus(EmkCargoSpaceEntity t)
    throws Exception
  {}
