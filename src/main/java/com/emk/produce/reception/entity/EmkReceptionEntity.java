  ...
  implements Serializable
{
  ...
  @Excel(name="业务接待单号", width=15.0D)
  private String recevieNum;
  @Excel(name="接待单日期", width=15.0D)
  ...
  @Excel(name="接待事由", width=15.0D)
  private String recevieDesc;
  @Excel(name="接待地点", width=15.0D)
  private String address;
  @Excel(name="接待时间", width=15.0D)
  private String jdsj;
  @Excel(name="出席人员", width=15.0D)
