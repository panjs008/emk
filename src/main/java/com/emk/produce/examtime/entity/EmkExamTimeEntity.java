...
public class EmkExamTimeEntity
  implements Serializable
{
  ...
  private String size;
  @Excel(name="预计中期验货日期", width=15.0D)
  private String zqyhDate;
  @Excel(name="预计尾期验货日期", width=15.0D)
  private String wqyhDate;
  @Excel(name="距交期剩余天数", width=15.0D)
  private Integer levelDays;
  @Excel(name="中期验货状态", width=15.0D)
  private String zqyhState;
  @Excel(name="距中期验货剩余天数", width=15.0D)
  private Integer levealZqyh;
  @Excel(name="确认中期验货日期", width=15.0D)
  private String qrzqyhDate;
  @Excel(name="尾期验货状态", width=15.0D)
  private String wqyhState;
  @Excel(name="距尾期验货剩余天数", width=15.0D)
  private Integer levealWqyh;
  @Excel(name="确认尾期验货日期", width=15.0D)
