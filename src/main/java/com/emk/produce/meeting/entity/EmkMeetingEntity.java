  ...
  implements Serializable
{
  ...
  @Excel(name="会议记录表编号", width=15.0D)
  private String meetingNo;
  @Excel(name="会议时间", width=15.0D)
  private String meetingDate;
  @Excel(name="会议记录人", width=15.0D)
  private String recorder;
  @Excel(name="会议记录人ID", width=15.0D)
  private String recorderId;
  @Excel(name="会议地点", width=15.0D)
  private String address;
  @Excel(name="入会人员", width=15.0D)
  ...
  @Excel(name="中期检查时间", width=15.0D)
  private String zqjcDate;
  @Excel(name="尾期检查时间", width=15.0D)
  private String wqjcDate;
  @Excel(name="会议记录", width=15.0D)
  private String content;
  @Excel(name="技术部布面意见", width=15.0D)
  private String jsbbmAdvice;
  @Excel(name="技术部染色意见", width=15.0D)
  private String jsbranAdvice;
  @Excel(name="缝制部意见", width=15.0D)
  private String fzAdvice;
  @Excel(name="烫标组意见", width=15.0D)
  private String tbzAdvice;
  @Excel(name="包装组意见", width=15.0D)
  private String bzAdvice;
  @Excel(name="采购部意见", width=15.0D)
  private String cgAdvice;
  @Excel(name="业务部意见", width=15.0D)
  private String ybAdvice;
  @Excel(name="质检组意见", width=15.0D)
  private String zjzAdvice;
  @Excel(name="计划部意见", width=15.0D)
  private String jhbAdvice;
  @Excel(name="生产部综合意见", width=15.0D)
