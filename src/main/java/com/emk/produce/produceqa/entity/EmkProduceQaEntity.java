  ...
  implements Serializable
{
  ...
  @Excel(name="出厂日期", width=15.0D)
  private String outDate;
  @Excel(name="距交期剩余天数", width=15.0D)
  ...
  @Excel(name="生产问题函号", width=15.0D)
  private String qaNo;
  @Excel(name="发函日期", width=15.0D)
  ...
  @Excel(name="收函部门", width=15.0D)
  private String recevieDeptName;
  @Excel(name="收函部门代码", width=15.0D)
  private String recevieDeptCode;
  @Excel(name="收函人", width=15.0D)
  private String recevier;
  @Excel(name="抄送部门", width=15.0D)
  private String copyDeptName;
  @Excel(name="抄送部门代码", width=15.0D)
  private String copyDeptCode;
  @Excel(name="抄送收函人", width=15.0D)
  private String copyer;
  @Excel(name="问题描述", width=15.0D)
  private String qaDesc;
  @Excel(name="经济损失", width=15.0D)
  private String loss;
  @Excel(name="解决方案", width=15.0D)
  private String solve;
  @Excel(name="相关抄送人意见", width=15.0D)
  private String copyerAdvice;
  @Excel(name="财务意见", width=15.0D)
  private String cwAdvice;
  @Excel(name="总经理意见", width=15.0D)
  private String zjlAdvice;
  @Excel(name="生产问题函状态", width=15.0D)
  private String qaState;
  @Excel(name="扫描件", width=15.0D)
  ...
  @Excel(name="发函部门", width=15.0D)
  private String sendDeptName;
  @Excel(name="发函部门代码", width=15.0D)
  private String sendDeptCode;
  @Excel(name="发函人", width=15.0D)
