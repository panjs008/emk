...
<div class="ui_main" align="center">
	<div class="ui_buttons">
		...
		<%--<input class="ui_state_highlight" onClick="document.getElementById('printfrm').contentWindow.bcsave();" value="保存草稿" type="button">--%>
		<input class="ui_state_highlight" onClick="document.getElementById('printfrm').contentWindow.doSaveOrder();" value="结单不打印" type="button">
