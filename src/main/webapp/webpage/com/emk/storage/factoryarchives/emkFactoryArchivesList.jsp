...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkFactoryArchivesList" checkbox="false" pagination="true" fitColumns="true" title="" actionUrl="emkFactoryArchivesController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgCol title="供应商档案编号" query="true" field="archivesNo"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="工厂名称"  query="true" field="companyNameZn"  queryMode="single"  width="150"></t:dgCol>
   <t:dgCol title="工厂代码"  query="true" field="companyCode"  queryMode="single"  width="90"></t:dgCol>
   <t:dgCol title="地址"  field="addressZn"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgCol title="产业类型" formatterjs="bhFormat" field="productClassification"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="营业执照号"  field="licenseNumber"  queryMode="single"  width="120"></t:dgCol>
