	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" colspan="3">
				<input id="cusName" name="cusName" value="${emkSampleRequiredPage.cusName }" readonly type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" >
				<input id="businesser" name="businesser" readonly value="${emkSampleRequiredPage.businesser }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value">
				<input id="ysDate" name="ysDate" readonly value="${emkSampleRequiredPage.ysDate }" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="oneMakeDate" name="oneMakeDate" value="${emkSampleRequiredPage.oneMakeDate }" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
