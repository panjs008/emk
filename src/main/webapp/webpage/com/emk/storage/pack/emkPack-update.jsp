...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkPackController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="businesser" name="businesser" readonly type="text" value="${emkPackPage.businesser }" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="cusName" name="cusName" readonly type="text" style="width: 150px" value="${emkPackPage.cusName }" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value">
				<input id="ysDate" name="ysDate" readonly value="${emkPackPage.ysDate }" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				...
				<img id="uploadimg" src="${emkPackPage.oldImageUrl eq null ? 'images/bjlogo.png':emkPackPage.oldImageUrl}" width="150" height="150">
