...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkPackController.do?doUpdate" tiptype="1">
	<input id="id" name="id" type="hidden" value="${emkPackPage.id }"/>
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="cusNum" name="cusNum" readonly type="text" value="${emkPackPage.cusNum }" style="width: 150px" class="inputxt"  ignore="ignore" />
			...
			<td class="value" style="width: 32%">
				<input id="cusName" name="cusName" readonly type="text" style="width: 150px" value="${emkPackPage.cusName }" class="inputxt"  datatype="*"/>
		...
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="businesseDeptName" name="businesseDeptName" readonly value="${emkPackPage.businesseDeptName }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<input id="businesseDeptId" name="businesseDeptId"  type="hidden"  value="${emkPackPage.businesseDeptId }"/>
				<span class="Validform_checktip"></span>
			...
			<td class="value" style="width: 32%">
				...
				<input id="businesser" name="businesser" readonly type="hidden" value="${emkPackPage.businesser }" style="width: 150px" class="inputxt"  ignore="ignore" />
				<input id="businesserName" name="businesserName"  type="hidden"  value="${emkPackPage.businesserName }"/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				...
				<span class="Validform_checktip"></span>
				<label class="Validform_label" style="display: none;">包装辅料需求单号</label>
			</td>
		</tr>
		<tr>
			<td align="right">
		...
		<%--<tr>
			...
			<td class="value">
				<input id="weight" name="weight" type="text" style="width: 150px" value="${emkPackPage.weight }" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="chengf" name="chengf" type="text" style="width: 150px" value="${emkPackPage.chengf }" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="brand" name="brand" type="text" style="width: 150px" value="${emkPackPage.brand }" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="targetPrice" name="targetPrice" type="text" style="width: 150px" value="${emkPackPage.targetPrice }" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="total" name="total" type="text" style="width: 150px" class="inputxt"  value="${emkPackPage.total }" ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="endDate" name="endDate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="${emkPackPage.endDate }" type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="levelDays" name="levelDays" type="text" style="width: 150px" value="${emkPackPage.levelDays }" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr id="dgrImageDiv" >
			...
			<td class="value">
				...
				<img id="uploadimg0" src="${emkPackPage.customSampleUrl eq '' ? 'images/bjlogo.png':emkPackPage.customSampleUrl}" width="150" height="150">
				...
				</t:upload>[<a href="javascript:findDetail('${emkPackPage.customSampleUrl }')">${emkPackPage.customSample }</a>]
			...
			<td class="value">
				...
				<img id="uploadimg3" src="${emkPackPage.dgrImageUrl eq '' ? 'images/bjlogo.png':emkPackPage.dgrImageUrl}" width="150" height="150">
				...
				</t:upload>[<a href="javascript:findDetail('${emkPackPage.dgrImageUrl }')">${emkPackPage.dgrImage }</a>]
		...
		<tr>
			...
			<td class="value">
				<input id="oldImage" name="oldImage" type="hidden" value="${emkPackPage.oldImage }"/>
				<img id="uploadimg" src="${emkPackPage.oldImageUrl eq '' ? 'images/bjlogo.png':emkPackPage.oldImageUrl}" width="150" height="150">
				...
				<input id="oldImageUrl" name="oldImageUrl" type="hidden" value="${emkPackPage.oldImageUrl }"/>
			</td>
			...
			<td class="value">
				<img id="uploadimg2" src="${emkPackPage.ckImageUrl eq '' ? 'images/bjlogo.png':emkPackPage.ckImageUrl}" width="150" height="150">
				...
				</t:upload>[<a href="javascript:findDetail('${emkPackPage.ckImageUrl }')">${emkPackPage.ckImage }</a>]
		...
		<tr>
			...
			<td class="value" colspan="3">
				<textarea  id="sampleNoDesc" style="width:95%;height:70px" class="inputxt" rows="5" name="sampleNoDesc">${emkPackPage.sampleNoDesc }</textarea>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				<textarea  id="remark" style="width:95%;height:70px" class="inputxt" rows="5" name="remark">${emkPackPage.remark }</textarea>
				<span class="Validform_checktip"></span>
