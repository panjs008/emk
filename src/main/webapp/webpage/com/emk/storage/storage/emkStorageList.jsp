...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkStorageList" checkbox="false" pagination="true" fitColumns="true" title="" actionUrl="emkStorageController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgCol title="所属部门"  field="sysOrgCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
      ...
      <t:dgCol title="产品编号"  field="proNum" query="true" queryMode="single"  width="120"></t:dgCol>
      <t:dgCol title="商品类型"  field="proTypeName"  queryMode="single"  width="120"></t:dgCol>

      <t:dgCol title="商品ID"  field="proId" hidden="true" queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="中文描述"  field="proZnName" query="true"  queryMode="single"  width="120"></t:dgCol>
      <t:dgCol title="英文描述"  field="proEnName"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgCol title="商品类型"  field="proType"  hidden="true" queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="备注"  field="remark" hidden="true" queryMode="single"  width="120"></t:dgCol>
      <%-- <t:dgToolBar title="录入" icon="fa fa-plus" url="emkStorageController.do?goAdd" funname="add"></t:dgToolBar>
       <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkStorageController.do?goUpdate" funname="update"></t:dgToolBar>
       <t:dgToolBar title="批量删除"  icon="fa fa-remove" url="emkStorageController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
