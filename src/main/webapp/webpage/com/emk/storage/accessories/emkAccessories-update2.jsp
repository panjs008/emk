...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkAccessoriesController.do?doUpdate" tiptype="1">
	<input id="materailId" name="materailId" type="hidden" value="${emkAccessoriesPage.id }"/>
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" rowspan="6">
				...
				<c:if test="${emkAccessoriesPage.customSampleUrl ne null && emkAccessoriesPage.customSampleUrl ne ''}">[<a href="javascript:findDetail('${emkAccessoriesPage.customSampleUrl }')">${emkAccessoriesPage.customSample }</a>]</c:if>
				<span id="customSampleId"></span>
				<input id="customSampleUrl" name="customSampleUrl" type="hidden" value="${emkAccessoriesPage.customSampleUrl }"/>
			</td>
		</tr>
		<tr>
			<td align="right">
