...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkPriceController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" >
				<select class="form-control select2" id="businesserId"  style="width: 140px">
			...
			<td class="value">
				<input id="proTypeName" name="proTypeName" datatype="*" value="${emkPricePage.proTypeName }" type="text" style="width: 140px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" >
				...
				[<a href="javascript:findDetail('${emkPricePage.customSampleUrl }')">${emkPricePage.customSample }&nbsp;</a>]
			...
			<td class="value">
				...
				[<a href="javascript:findDetail('${emkPricePage.dgrImageUrl }')">${emkPricePage.dgrImage }&nbsp;</a>]
			...
			<td class="value">
				...
				[<a href="javascript:findDetail('${emkPricePage.oldImageUrl }')">${emkPricePage.oldImage }&nbsp;</a>]
			...
			<td class="value">
				...
				[<a href="javascript:findDetail('${emkPricePage.sizeImageUrl }')">${emkPricePage.sizeImage }&nbsp;</a>]
