	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" colspan="5">
				<input id="cusName" name="cusName" readonly type="text" style="width: 140px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" >
				<input id="businesseDeptName" name="businesseDeptName" readonly type="text" style="width: 140px" class="inputxt"  ignore="ignore" />
