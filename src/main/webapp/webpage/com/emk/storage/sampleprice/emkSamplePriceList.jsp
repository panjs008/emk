...
<t:datagrid name="emkSamplePriceList" checkbox="false" pagination="true" fitColumns="true" title="" actionUrl="emkSamplePriceController.do?datagrid&enquiryId=${param.enquiryId}" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
    ...
    <t:dgToolBar title="录入" icon="fa fa-plus" url="emkSamplePriceController.do?goAdd&enquiryId=${param.enquiryId}" funname="add"></t:dgToolBar>
    <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkSamplePriceController.do?goUpdate" funname="update"></t:dgToolBar>
    <t:dgToolBar title="删除"  icon="fa fa-remove" url="emkSamplePriceController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
