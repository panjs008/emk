	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="cusNum" name="cusNum" value="${emkCheckFactoryPage.cusNum }" readonly type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value" style="width: 32%">
				<input id="cusName" name="cusName" value="${emkCheckFactoryPage.cusName }" readonly type="text" style="width: 150px" class="inputxt"  datatype="*"/>
		...
		<tr>
			...
			<td class="value">
				...
				<input id="gysCode" name="gysCode" type="hidden" value="${emkCheckFactoryPage.gysCode }" style="width: 150px" class="inputxt"  ignore="ignore" />
			...
			<td class="value">
				<input id="gysType" name="gysType" type="text" value="${emkCheckFactoryPage.gysType }" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="kdDate" name="kdDate" value="${emkCheckFactoryPage.kdDate }"  readonly onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="shDate" name="shDate" readonly  value="${emkCheckFactoryPage.shDate }" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'kdDate\');}'})" type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="factoryAddress" name="factoryAddress" type="text" value="${emkCheckFactoryPage.factoryAddress }"  style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				<textarea  id="checkContent" style="width:95%;height:70px" class="inputxt" rows="5" name="checkContent">${emkCheckFactoryPage.checkContent }</textarea>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				<textarea  id="brand" style="width:95%;height:70px" class="inputxt" rows="5" name="brand">${emkCheckFactoryPage.brand }</textarea>
				<span class="Validform_checktip"></span>
