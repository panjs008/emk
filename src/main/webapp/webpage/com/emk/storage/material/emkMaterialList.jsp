...
<div id="main_list"  class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkMaterialList" checkbox="false" pagination="true" fitColumns="false" title="" actionUrl="emkMaterialController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
      ...
      <t:dgToolBar title="录入" icon="fa fa-plus" operationCode="add" url="emkMaterialController.do?goAdd&winTitle=录入原料需求开发单" funname="add" height="600" width="1000"></t:dgToolBar>
      <t:dgToolBar title="编辑" icon="fa fa-edit" operationCode="edit" url="emkMaterialController.do?goUpdate&winTitle=编辑原料需求开发单" funname="update" height="600" width="1000"></t:dgToolBar>
      <t:dgToolBar title="查看" icon="fa fa-search" operationCode="look" url="emkMaterialController.do?goUpdate&winTitle=查看原料需求开发单" funname="detail" height="580" width="1000"></t:dgToolBar>
