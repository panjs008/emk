...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkInStorageDetailList" checkbox="false" pagination="true" fitColumns="true" title="入库表明细表" actionUrl="emkInStorageDetailController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="emkInStorageDetailController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
       <t:dgToolBar title="录入" icon="fa fa-plus" url="emkInStorageDetailController.do?goAdd" funname="add"></t:dgToolBar>
       <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkInStorageDetailController.do?goUpdate" funname="update"></t:dgToolBar>
       <t:dgToolBar title="批量删除"  icon="fa fa-remove" url="emkInStorageDetailController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
