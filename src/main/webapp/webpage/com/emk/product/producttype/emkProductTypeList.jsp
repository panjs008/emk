...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:0px;border:0px">
      <t:datagrid name="emkProductTypeList" checkbox="true" treegrid="true" pagination="true" fitColumns="false" title="" actionUrl="emkProductTypeController.do?treegrid" idField="id" fit="true" btnCls="bootstrap" queryMode="group">
   ...
   <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkProductTypeController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="删除"  icon="fa fa-remove" url="emkProductTypeController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
