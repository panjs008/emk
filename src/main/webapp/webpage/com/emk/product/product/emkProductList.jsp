...
<div class="easyui-layout" fit="true">
 <div region="west" style="width: 200px;" title="产品类别" split="true">
  ...
  <div region="center" style="padding:0px;border:0px">
      <t:datagrid name="emkProductList" checkbox="true"  pagination="true" fitColumns="false" title="" actionUrl="emkProductController.do?datagrid&type=0" idField="id" fit="true" btnCls="bootstrap" queryMode="group">
   ...
   <t:dgCol title="规格"  field="brand"  queryMode="single"  width="150"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="fa fa-plus" operationCode="add" url="emkProductController.do?goAdd&type=0&winTitle=录入原料面料" funname="add" width="800" height="400"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="fa fa-edit" operationCode="edit" url="emkProductController.do?goUpdate&winTitle=编辑原料面料" funname="update" width="800" height="400"></t:dgToolBar>
