...
<div class="easyui-layout" fit="true">
 <div region="west" style="width: 200px;" title="产品类别" split="true">
  ...
  <div region="center" style="padding:0px;border:0px">
   ...
   <t:dgToolBar title="录入" icon="fa fa-plus" url="emkProductController.do?goAdd&type=2&winTitle=录入包装辅料" funname="add" width="800" height="400"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkProductController.do?goUpdate&winTitle=编辑包装辅料" funname="update" width="800" height="400"></t:dgToolBar>
