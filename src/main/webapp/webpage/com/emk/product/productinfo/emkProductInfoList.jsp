...
<div class="easyui-layout" fit="true">
    ...
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="emkProductInfoList" checkbox="true"  pagination="true" fitColumns="false" title="" actionUrl="emkProductInfoController.do?datagrid" idField="id" fit="true" btnCls="bootstrap" queryMode="group">
            ...
            <t:dgToolBar title="录入" icon="fa fa-plus" url="emkProductInfoController.do?goAdd" funname="add" width="800" height="400"></t:dgToolBar>
            <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkProductInfoController.do?goUpdate" funname="update" width="800" height="400"></t:dgToolBar>
            <t:dgToolBar title="删除"  icon="fa fa-remove" url="emkProductInfoController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
