...
<head>
	...
	<script type="text/javascript">
		$(function() {
			BindSelect("gysId","ymkCustomController.do?findSupplierList",1,"${emkReceptionPage.gysCode},${emkReceptionPage.gys}");
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkReceptionController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="businesser" name="businesser" readonly value="${emkReceptionPage.businesser }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="cusName" name="cusName" readonly value="${emkReceptionPage.cusName }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="tracer" name="tracer" readonly type="text" value="${emkReceptionPage.tracer }" style="width: 150px" class="inputxt"  ignore="ignore" />
			...
			<td class="value" style="width: 32%">
				<input id="developer" name="developer" readonly value="${emkReceptionPage.developer }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" colspan="3">
				<textarea  id="sampleNoDesc" style="width:95%;height:50px" class="inputxt" rows="3" name="sampleNoDesc">${emkReceptionPage.sampleNoDesc }</textarea>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="recevieDesc" name="recevieDesc" type="text" style="width: 150px" class="inputxt"  value="${emkReceptionPage.recevieDesc }" ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				<input id="realName" name="realName" type="text" readonly style="width: 300px" value="${emkReceptionPage.outUserNames }" class="inputxt" >
