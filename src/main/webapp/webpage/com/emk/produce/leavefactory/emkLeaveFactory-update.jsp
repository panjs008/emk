...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkLeaveFactoryController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="businesser" name="businesser" readonly value="${emkLeaveFactoryPage.businesser }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="cusName" name="cusName" readonly type="text" value="${emkLeaveFactoryPage.cusName }" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="tracer" name="tracer" readonly type="text" value="${emkLeaveFactoryPage.tracer }" style="width: 150px" class="inputxt"  ignore="ignore" />
			...
			<td class="value" style="width: 32%">
				<input id="developer" name="developer" readonly type="text" value="${emkLeaveFactoryPage.developer }" style="width: 150px" class="inputxt"  ignore="ignore" />
