            ...
            <c:forEach items="${emkProOrderDetailEntities}" var="poVal" varStatus="status">
                <tr>
                    ...
                    <td align="center"><input  nullmsg="请输入描述！"  errormsg="请输入描述" value="${poVal.sampleDesc}" name="orderMxList[${status.index}].sampleDesc00" maxlength="100" type="text" value=""
                                               style="width: 86%;" ignore="ignore"></td>
                    <td align="center"><input  nullmsg="请输入总箱数！"  errormsg="请输入整数" datatype="n" value="${poVal.sumBox}" name="orderMxList[${status.index}].sumBox00" maxlength="100" type="text" value=""
                                               style="width: 86%;" ignore="ignore"></td>
                    <td align="center"><input  nullmsg="请输入总体积！"  errormsg="请输入数值" datatype="d" value="${poVal.sumVol}" name="orderMxList[${status.index}].sumVol00" maxlength="100" type="text" value=""
                                               style="width: 86%;" ignore="ignore"></td>
                    <td align="center"><input  nullmsg="请输入总毛重！"  errormsg="请输入数值" datatype="d" value="${poVal.sumMao}" name="orderMxList[${status.index}].sumMao00" maxlength="100" type="text" value=""
                                               style="width: 86%;" ignore="ignore"></td>
                    <td align="center"><input  nullmsg="请输入总净重！"  errormsg="请输入数值" datatype="d" value="${poVal.sumJz}" name="orderMxList[${status.index}].sumJz00" maxlength="100" type="text" value=""
                                               style="width: 86%;" ignore="ignore"></td>
                </tr>
            </c:forEach>
        </c:if>
