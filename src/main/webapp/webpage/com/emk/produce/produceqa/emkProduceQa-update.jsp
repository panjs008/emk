...
<head>
	...
	<script type="text/javascript">
		//编写自定义JS代码
		$(function() {
			BindSelect("gysId","ymkCustomController.do?findSupplierList",1,"${emkProduceQaPage.gysCode},${emkProduceQaPage.gys}");
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkProduceQaController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="businesser" name="businesser" value="${emkProduceQaPage.businesser }" readonly type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="cusName" name="cusName" value="${emkProduceQaPage.cusName }" readonly type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" style="width: 32%">
				<input id="tracer" name="tracer" value="${emkProduceQaPage.tracer }" readonly type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
			...
			<td class="value" style="width: 32%">
				<input id="developer" name="developer" value="${emkProduceQaPage.developer }" readonly type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
