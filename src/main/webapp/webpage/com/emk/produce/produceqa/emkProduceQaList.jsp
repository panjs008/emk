...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkProduceQaList" checkbox="false" pagination="true" fitColumns="true" title="" actionUrl="emkProduceQaController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="emkProduceQaController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
       <t:dgToolBar title="录入" icon="fa fa-plus" url="emkProduceQaController.do?goAdd&winTitle=录入单生产问题单" funname="add" height="600" width="1000"></t:dgToolBar>
       <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkProduceQaController.do?goUpdate&winTitle=编辑单生产问题单" funname="update" height="600" width="1000"></t:dgToolBar>
       <t:dgToolBar title="删除"  icon="fa fa-remove" url="emkProduceQaController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
