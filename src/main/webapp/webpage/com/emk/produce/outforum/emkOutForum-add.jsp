...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#detailId").load("emkOutForumController.do?orderMxList");
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkOutForumController.do?doAdd" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
				<input id="skDate" name="skDate" readonly value="${emkOutForumPage.outDate}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
