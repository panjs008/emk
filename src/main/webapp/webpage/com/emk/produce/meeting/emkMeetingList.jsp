...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkMeetingList" checkbox="false" pagination="true" fitColumns="true" title="" actionUrl="emkMeetingController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgCol title="款式大类"  field="proTypeName"  queryMode="single"  width="70"></t:dgCol>
       <t:dgToolBar title="录入" icon="fa fa-plus" url="emkMeetingController.do?goAdd&winTitle=录入产前会议通知单" funname="add" height="600" width="1000"></t:dgToolBar>
       <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkMeetingController.do?goUpdate&winTitle=编辑产前会议通知单" funname="update" height="600" width="1000"></t:dgToolBar>
       <t:dgToolBar title="删除"  icon="fa fa-remove" url="emkMeetingController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
