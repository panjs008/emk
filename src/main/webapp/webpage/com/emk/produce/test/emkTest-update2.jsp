...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkTestController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr id="dgrImageDiv">
			...
			<td class="value">
				<input id="testContent" name="testContent" value="${emkTestPage.testContent }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />[<a href="emkTestController.do?dowaLoadFile&id=${emkTestPage.id}&testContentUrl=${emkTestPage.testContentUrl }">下载</a>]
