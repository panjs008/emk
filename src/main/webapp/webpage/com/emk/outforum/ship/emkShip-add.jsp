...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkShipController.do?doAdd" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value"  >
				<input id="businesser" name="businesser" readonly value="${emkShipPage.businesser }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
			...
			<td class="value" >
				<input id="tracer" name="tracer" readonly type="text" value="${emkShipPage.tracer }" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" colspan="3">
				<input id="cusName" name="cusName" readonly type="text" value="${emkShipPage.cusName }" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value">
				<input id="developer" name="developer" readonly value="${emkShipPage.developer }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value" colspan="5">
				<textarea  id="shipDesc" style="width:95%;height:50px" class="inputxt" rows="3" name="shipDesc">${emkCargoSpacePage.sampleNoDesc }</textarea>
				<span class="Validform_checktip"></span>
