...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkPassFactoryList" checkbox="false" pagination="true" fitColumns="true" title="" actionUrl="emkPassFactoryController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
      ...
      <t:dgToolBar title="录入" icon="fa fa-plus" url="emkPassFactoryController.do?goAdd&winTitle=录入离厂放行单" funname="add" height="600" width="1000"></t:dgToolBar>
      <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkPassFactoryController.do?goUpdate&winTitle=编辑离厂放行单" funname="update" height="600" width="1000"></t:dgToolBar>
      <t:dgToolBar title="删除"  icon="fa fa-remove" url="emkPassFactoryController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
