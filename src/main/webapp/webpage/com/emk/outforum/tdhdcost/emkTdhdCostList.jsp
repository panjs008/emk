...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkTdhdCostList" checkbox="false" pagination="true" fitColumns="true" title="" actionUrl="emkTdhdCostController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgToolBar title="录入" icon="fa fa-plus" url="emkTdhdCostController.do?goAdd&winTitle=录入提单货代费用" funname="add" height="600" width="1000"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkTdhdCostController.do?goUpdate&winTitle=编辑提单货代费用" funname="update" height="600" width="1000"></t:dgToolBar>
   <t:dgToolBar title="删除"  icon="fa fa-remove" url="emkTdhdCostController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
