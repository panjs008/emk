...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			BindSelect("gysId","ymkCustomController.do?findSupplierList",1,"${emkFobBusinessPage.gysCode},${emkFobBusinessPage.gys}");
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkFobBusinessController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" >
				<input id="businesser" name="businesser" readonly value="${emkFobBusinessPage.businesser }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
			...
			<td class="value" >
				<input id="tracer" name="tracer" readonly type="text" value="${emkFobBusinessPage.tracer }" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value"  colspan="3">
				<input id="cusName" name="cusName" readonly type="text" value="${emkFobBusinessPage.cusName }" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value">
				<input id="developer" name="developer" readonly value="${emkFobBusinessPage.developer }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
