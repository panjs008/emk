...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkMInStorageList" checkbox="false" pagination="true" fitColumns="true" title="" actionUrl="emkMInStorageController.do?datagrid&type=2" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
      ...
      <t:dgToolBar title="查看" icon="fa fa-search" operationCode="look" url="emkMInStorageController.do?goUpdate&winTitle=查看包装辅料入库申请单" funname="detail" height="600" width="1100"></t:dgToolBar>
