...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#detailId").load("emkMInStorageController.do?emkMInStorageDetailList&selectType=0");
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkMInStorageController.do?doAdd" tiptype="1">
	...
	<c:set var="selectType" value="${param.type }"  scope="session"></c:set>
	...
	<table style="width:100%;display: none" cellpadding="0" cellspacing="2" border="0">
		...
		<tr>
			...
			<td align="left"><input nullmsg="请输入入库数量！" id="inTotal00" errormsg="输入入库数量内容不正确" name="rkglMxList[#index#].inTotal" maxlength="100" type="text" value=""
									style="width: 95%;"></td>
			<td align="left"><input nullmsg="请输入实际入库数量！" id="actualTotal00" errormsg="输入实际入库内容不正确" name="rkglMxList[#index#].actualTotal" maxlength="100" type="text" value=""
									style="width: 95%;"></td>
