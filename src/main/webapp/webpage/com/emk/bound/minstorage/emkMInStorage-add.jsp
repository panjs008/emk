...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkMInStorageController.do?doAdd" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" colspan="7">
				<input id="realName" name="realName" value="${LOCAL_CLINET_USER.realName}"  type="text" readonly style="width: 30%" class="inputxt" >
		...
		<tr>
			...
			<td class="value">
				<input id="orderNo" name="orderNo" datatype="*" value="${emkMInStoragePage.orderNo}" type="text" style="width: 150px" class="inputxt"  />
				<span class="Validform_checktip"></span>
	...
	<t:tabs id="inboundDetail" iframe="false"  tabPosition="top" fit="false">
		<t:tab href="emkMInStorageController.do?orderMxList&type=${param.type}&inStorageId=${emkMInStoragePage.id}" icon="icon-search" title="${pactTypeName}" id="detail"></t:tab>
	</t:tabs>
