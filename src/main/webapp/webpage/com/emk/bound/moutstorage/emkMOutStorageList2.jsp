...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkMOutStorageList" checkbox="false" pagination="true" fitColumns="true" title="" actionUrl="emkMOutStorageController.do?datagrid&type=1" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
      ...
      <t:dgToolBar title="录入" icon="fa fa-plus" operationCode="add" url="emkMOutStorageController.do?goAdd&type=1&winTitle=添加缝制辅料出库申请单" funname="add" height="600" width="1200"></t:dgToolBar>
      <t:dgToolBar title="编辑" icon="fa fa-edit" operationCode="edit" url="emkMOutStorageController.do?goUpdate&type=1&winTitle=编辑缝制辅料出库申请单" funname="update" height="600" width="1200"></t:dgToolBar>
      <t:dgToolBar title="查看" icon="fa fa-search" operationCode="look" url="emkMOutStorageController.do?goUpdate&type=1&winTitle=查看缝制辅料出库申请单" funname="detail" height="600" width="1200"></t:dgToolBar>
