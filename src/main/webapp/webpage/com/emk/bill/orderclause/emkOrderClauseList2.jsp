...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:0px;border:0px">
   ...
   <t:dgToolBar title="录入" icon="fa fa-plus" url="emkOrderClauseController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkOrderClauseController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="删除"  icon="fa fa-remove" url="emkOrderClauseController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
