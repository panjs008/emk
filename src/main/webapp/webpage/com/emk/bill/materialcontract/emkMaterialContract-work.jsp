		...
		<c:if test="${orderFinish eq '0' && orderPorcess.taskDefinitionKey eq 'checkTask'}">
			<tr>
				...
				<td class="value" colspan="3">
					<input name="isPass" type="radio" datatype="*" <c:if test="${emkMaterialContractPage.isPass eq '0'}">checked="true"</c:if> value="0">
					是
					<input name="isPass" type="radio" datatype="*"  <c:if test="${emkMaterialContractPage.isPass eq '1'}">checked="true"</c:if> value="1">
					否
