...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#detailId").load("emkMaterialContractController.do?emkMaterialContractDetailList&selectType=0");
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkMaterialContractController.do?doAdd" tiptype="1">
	<input id="id" name="id" type="hidden" value="${emkMaterialContractPage.id }"/>
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" colspan="3">
				<input id="levelDays" name="leaveLimit" readonly type="text" value="${emkMaterialContractPage.leaveLimit }" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
