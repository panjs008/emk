...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkMaterialContractList" checkbox="false" pagination="true" fitColumns="true" title="" actionUrl="emkMaterialContractController.do?datagrid&type=0" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
      ...
      <t:dgCol title="原料面料开发费付款申请单编号"  query="true"  field="payNo" queryMode="single" width="210"></t:dgCol>
      <t:dgCol title="原料面料需求单号"  query="true"  field="requireNo" queryMode="single" width="130"></t:dgCol>
      <t:dgCol title="原料面料采购单号"  query="true"  field="caigouNo" queryMode="single" width="130"></t:dgCol>
      ...
      <t:dgToolBar title="录入" icon="fa fa-plus" operationCode="add" url="emkMaterialContractController.do?goAdd&type=0&winTitle=录入原料采购单" funname="add" height="600" width="1200"></t:dgToolBar>
      <t:dgToolBar title="编辑" icon="fa fa-edit" operationCode="edit" url="emkMaterialContractController.do?goUpdate&type=0&winTitle=编辑原料采购单" funname="update" height="600" width="1200"></t:dgToolBar>
      <t:dgToolBar title="查看" icon="fa fa-search" operationCode="look" url="emkMaterialContractController.do?goUpdate&type=0&winTitle=查看原料采购单" funname="detail" height="600" width="1200"></t:dgToolBar>
