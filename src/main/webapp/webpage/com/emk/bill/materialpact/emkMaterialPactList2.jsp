...
<div id="main_list" class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkMaterialPactList" checkbox="false" pagination="true" fitColumns="false" title="" actionUrl="emkMaterialPactController.do?datagrid&type=1" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgCol title="合同编号"  field="htNum" queryMode="single" width="100"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="fa fa-plus" url="emkMaterialPactController.do?goAdd&type=1&winTitle=录入缝制预采购合同单" funname="add" height="600" width="1000"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkMaterialPactController.do?goUpdate&type=1&winTitle=编辑缝制预采购合同单" funname="update" height="600" width="1000"></t:dgToolBar>
