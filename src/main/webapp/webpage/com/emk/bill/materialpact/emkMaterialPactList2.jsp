...
<div id="main_list" class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkMaterialPactList" checkbox="false" pagination="true" fitColumns="false" title="" actionUrl="emkMaterialPactController.do?datagrid&type=1&flag=0" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgFunOpt funname="queryDetail2(id,materialNo)" title="缝制辅料" urlclass="ace_button" urlfont="fa-list-alt"></t:dgFunOpt>
      ...
      <%--<t:dgToolBar title="录入" icon="fa fa-plus" operationCode="add" url="emkMaterialPactController.do?goAdd&type=0&winTitle=录入缝制预采购合同单" funname="add" height="600" width="1000"></t:dgToolBar>--%>
      <t:dgToolBar title="查看" icon="fa fa-search" operationCode="look" url="emkMaterialPactController.do?goUpdate&type=1&winTitle=查看缝制预采购合同单" funname="detail" height="600" width="1000"></t:dgToolBar>
      <t:dgToolBar title="编辑" icon="fa fa-edit" operationCode="edit" url="emkMaterialPactController.do?goUpdate&type=1&winTitle=编辑缝制预采购合同单" funname="update" height="600" width="1000"></t:dgToolBar>
