	...
	<table style="width: 100%;margin-top: 5px" cellpadding="0" cellspacing="1" class="formtable">
			...
			<td class="value" >
				<select id="businesser"  name="businesser" datatype="*">
					...
					<c:forEach items="${ywyList}" var="ywy">
						<option value='${ywy.userName}' ${ywy.userName eq emkMaterialPactPage.businesser ? 'selected':''}>${ywy.realName}</option>
					</c:forEach>
				</select>
			...
			<td class="value" >
				<select id="tracer"  name="tracer" datatype="*">
					...
					<c:forEach items="${ywgdyList}" var="ywgdy">
						<option value='${ywgdy.userName}' ${ywgdy.userName eq emkMaterialPactPage.tracer ? 'selected':''}>${ywgdy.realName}</option>
					</c:forEach>
				</select>
		...
		<tr>
			...
			<td class="value">
				...
				<input id="proTypeName" name="proTypeName" datatype="*"  value="${emkMaterialPactPage.proTypeName }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
			...
			<td class="value" >
				<select id="developer"  name="developer" datatype="*">
					...
					<c:forEach items="${scgdyList}" var="scgdy">
						<option value='${scgdy.userName}'  ${scgdy.userName eq emkMaterialPactPage.developer ? 'selected':''}>${scgdy.realName}</option>
					</c:forEach>
				</select>
