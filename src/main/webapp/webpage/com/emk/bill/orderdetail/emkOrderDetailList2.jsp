...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:0px;border:0px">
   ...
   <t:dgDelOpt title="删除" url="emkOrderDetailController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   ...
   <t:dgToolBar title="批量删除"  icon="fa fa-remove" url="emkOrderDetailController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
