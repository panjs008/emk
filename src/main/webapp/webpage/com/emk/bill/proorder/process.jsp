...
<div id="orderDiv" title="流程图" style="width:100%;height:350px;overflow:hidden" >
    <iframe scrolling="no" id="processFrm" frameborder="0" style=""  src="emkProOrderController.do?showProcess&id=${param.id}" width="100%" height="100%"></iframe>
</div>
...
<div class="easyui-layout" fit="true" style="height: 100px">
    <div region="center" style="padding:0px;border:0px;">
        <t:datagrid name="instorageList" checkbox="false" pagination="true" fitColumns="true" title="" actionUrl="flowController.do?hisProcessDatagrid&sqlType=bill&id=${param.id}" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
            <t:dgCol title="流程节点"  field="NAME_"  queryMode="single"  width="120"></t:dgCol>
            <t:dgCol title="操作人"  field="workname"  queryMode="single"  width="120"></t:dgCol>
