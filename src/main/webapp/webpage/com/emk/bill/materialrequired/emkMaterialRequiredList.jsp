...
<div id="main_list" class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkMaterialRequiredList" checkbox="false" pagination="true" fitColumns="false" title="" actionUrl="emkMaterialRequiredController.do?datagrid&type=0" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
      ...
      <t:dgCol title="需求单号"  field="materialNo" queryMode="single" query="true"  width="100"></t:dgCol>
      ...
      <t:dgToolBar title="录入" icon="fa fa-plus" url="emkMaterialRequiredController.do?goAdd&type=0&winTitle=录入原料采购需求单" funname="add" height="600" width="1000"></t:dgToolBar>
      <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkMaterialRequiredController.do?goUpdate&type=0&winTitle=编辑原料采购需求单" funname="update" height="600" width="1000"></t:dgToolBar>
