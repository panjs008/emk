...
<div id="main_list" class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkMaterialRequiredList" checkbox="false" pagination="true" fitColumns="false" title="" actionUrl="emkMaterialRequiredController.do?datagrid&type=1" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
      ...
      <t:dgToolBar title="录入" icon="fa fa-plus" url="emkMaterialRequiredController.do?goAdd&type=1&winTitle=录入缝制采购需求单" funname="add" height="600" width="1000"></t:dgToolBar>
      <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkMaterialRequiredController.do?goUpdate&type=1&winTitle=编辑缝制采购需求单" funname="update" height="600" width="1000"></t:dgToolBar>
