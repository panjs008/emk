...
<html>
 <head>
  ...
  $(document).ready(function(){
	  $("#detailId").load("emkOfferPriceController.do?offerMxList");
  });
  </script>
 </head>
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkOfferPriceController.do?doAdd" tiptype="1">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
						<input id="cusNum" name="cusNum" type="hidden" style="width: 150px" class="inputxt"  ignore="ignore" />
				...
				<tr>
					...
					<td class="value">
						...
						<input id="proTypeName" name="proTypeName" type="hidden" style="width: 150px" class="inputxt"  ignore="ignore" />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="kdTime" name="kdTime" type="text" style="width: 150px"  readonly onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  class="Wdate"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" rowspan="5">
						<input id="customSample" name="customSample" type="hidden" style="width: 150px" class="inputxt"  ignore="ignore" />
						<input id="customSampleUrl" name="customSampleUrl" type="hidden" style="width: 150px" class="inputxt"  ignore="ignore" />
						<img id="uploadimg" src="${emkOfferPricePage.image1Url eq null ? 'images/bjlogo.png':emkOfferPricePage.image1Url}" width="150" height="150">
					...
					<td class="value">
						<input id="workPrice" name="workPrice" datatype="d" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
						<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="lossPrice" name="lossPrice" datatype="d" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="freightPrice" name="freightPrice" datatype="d" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
					<input id="tax" name="tax" type="text" datatype="d" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
					<span class="Validform_checktip"></span>
