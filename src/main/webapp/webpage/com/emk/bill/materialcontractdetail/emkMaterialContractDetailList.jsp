...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkMaterialContractDetailList" checkbox="false" pagination="true" fitColumns="true" title="采购单明细" actionUrl="emkMaterialContractDetailController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="emkMaterialContractDetailController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
       <t:dgToolBar title="录入" icon="fa fa-plus" url="emkMaterialContractDetailController.do?goAdd" funname="add"></t:dgToolBar>
       <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkMaterialContractDetailController.do?goUpdate" funname="update"></t:dgToolBar>
       <t:dgToolBar title="批量删除"  icon="fa fa-remove" url="emkMaterialContractDetailController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
