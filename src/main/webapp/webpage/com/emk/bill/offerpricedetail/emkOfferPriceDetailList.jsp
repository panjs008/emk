...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkOfferPriceDetailList" checkbox="false" pagination="true" fitColumns="true" title="报价方案明细" actionUrl="emkOfferPriceDetailController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="emkOfferPriceDetailController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
       <t:dgToolBar title="录入" icon="fa fa-plus" url="emkOfferPriceDetailController.do?goAdd" funname="add"></t:dgToolBar>
       <t:dgToolBar title="编辑" icon="fa fa-edit" url="emkOfferPriceDetailController.do?goUpdate" funname="update"></t:dgToolBar>
       <t:dgToolBar title="批量删除"  icon="fa fa-remove" url="emkOfferPriceDetailController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
